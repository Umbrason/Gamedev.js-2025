...
public class AIPetitionPhaseRandomData : AIPetitionPhaseData
{
    ...
    public override IEnumerator PlayingPhase(PetitionPhase Phase, AIConfigData Config, GameInstance GameInstance)
    {
        ...
        BuildingPetition petition = new BuildingPetition
        {
            PlayerID = GameInstance.ClientID,
            Position = targetPosition,
            Building = building,
            ResourceSources = new() { { builderPlayerId, BuildingExtensions.ConstructionCosts(building) } }
        };
